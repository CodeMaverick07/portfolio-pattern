    ...
    <Layout>
      <div className="overflow-hidden z-0">
        <div className="h-screen  ">
          ...
          >
            <div className="font-semibold text-black  md:mt-20 -mt-72 font-mont">
        ...
        <div className="my-20 ">
          <div className="text-center h-52 mx-20 rounded-xl shadow-xl md:mx-0">
            <h1 className="text-black py-10 font-mont font-bold text-4xl md:text-3xl ">
              Yes You Are Right...I am JavaScript Buff
            </h1>
          </div>
        </div>
        <div className="md:mx-5 mx-32 shadow-2xl bg-gray-100 -mt-36 rounded-xl ">
          <div className="h-96">
            <lottie-player
        ...
        <div>
          <div className="text-center h-52 mx-20 rounded-lg shadow-2xl md:mx-0">
            <h1 className="text-black py-10 font-mont font-bold text-4xl">
              My Dev Stack
            </h1>
          </div>
          <div className="md:mx-5 mx-32 shadow-2xl bg-gray-100 -mt-20 rounded-xl">
            <div className="h-96">
              <lottie-player
        ...
        <div>
          <div className=" mx-96 mt-20 rounded-lg shadow-2xl md:mx-10">
            <h1 className="text-4xl text-center  font-bold text-gray-500 p-4 md:text-3xl ">
              Who Is Hemant
            </h1>
          </div>
